...
interface BlueCartridgeTokenV0Interface extends ethers.utils.Interface {
  functions: {
...
export class BlueCartridgeTokenV0 extends BaseContract {
  ...
  interface: BlueCartridgeTokenV0Interface;
  ...
  callStatic: {
    ...
    mint(_amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
