...
interface GrayCartridgeTokenV0Interface extends ethers.utils.Interface {
  functions: {
...
export class GrayCartridgeTokenV0 extends BaseContract {
  ...
  interface: GrayCartridgeTokenV0Interface;
