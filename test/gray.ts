...
import { GrayCartridgeTokenV0 } from "../typechain-types/GrayCartridgeTokenV0";
import { GrayCartridgeTokenV0__factory } from "../typechain-types/factories/GrayCartridgeTokenV0__factory";
import { ethers } from "hardhat";

describe("GrayCartrdigeTokenV0", async () => {
    const CARTRIDGE_CONFIG = {
        supply: 10000000000,
        name: "Gray Cartridge Game",
        symbol: "GCG",
        fee: 200,
    ...
    let cartridgeFactory: GrayCartridgeTokenV0__factory;
    let cartridgeContract: GrayCartridgeTokenV0;

    beforeEach(async () => {
        cartridgeFactory = (await ethers.getContractFactory(
            "GrayCartridgeTokenV0"
        )) as GrayCartridgeTokenV0__factory;
    ...
    describe("constructor()", () => {
        ...
        it("should set color correctly", async () => {
            ...
            expect(colorResponse).to.be.equal("gray");
        });
